...
export const getMyAssignments = (status?: TicketStatus) =>
  client.get<TicketList>('/agent/my-assignments', { params: status ? { status } : {} })

export const getTicket = (id: number) =>
  client.get<Ticket>(`/tickets/${id}`)

export const assignTicket = (id: number) =>
  client.post<Ticket>(`/agent/tickets/${id}/assign`)

export const acceptTicket = (id: number) =>
  client.post<Ticket>(`/agent/tickets/${id}/accept`)

export const closeTicket = (id: number) =>
  client.post<Ticket>(`/agent/tickets/${id}/close`)
