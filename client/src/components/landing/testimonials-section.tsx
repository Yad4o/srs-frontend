...
const testimonials = [
  {
    quote: "SRS auto-resolves the bulk of our login and payment tickets before an agent ever opens them.",
    author: "Sarah Chen",
    role: "Head of Support",
    company: "Meridian Labs",
    metric: { value: "68%", label: "Auto-resolve rate" },
  },
  {
    quote: "The 0.75 confidence gate is the killer feature. When it's unsure, it escalates — we never ship a wrong answer.",
    author: "Marcus Webb",
    role: "Support Operations",
    company: "Flux Systems",
    metric: { value: "0", label: "Wrong auto-replies" },
  },
  {
    quote: "Atomic assignment means no two agents grab the same escalated ticket. The race conditions just disappeared.",
    author: "Elena Rodriguez",
    role: "VP Engineering",
    company: "Beacon AI",
    metric: { value: "100%", label: "Conflict-free assign" },
  },
  {
    quote: "Spinning up the whole stack with Docker Compose and having migrations run on start saved us days.",
    author: "James Liu",
    role: "Platform Lead",
    company: "Prism Analytics",
    metric: { value: "4", label: "Services, one command" },
  },
];
...
export function TestimonialsSection() {
  ...
  return (
    <section ref={sectionRef} className="relative py-32 lg:py-40 bg-foreground text-background overflow-hidden">
      {/* ASCII background pattern — deterministic so SSR and client match */}
