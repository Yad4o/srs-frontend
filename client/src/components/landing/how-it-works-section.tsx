...
const steps = [
  {
    ...
    title: "Classify",
    subtitle: "the intent",
    description: "A ticket comes in and the classifier detects its intent and sub-intent — for example login_issue resolving to password_reset.",
    code: `POST /tickets/
{
  "message": "I can't log into
   my account"
}
// intent: login_issue (0.85)`,
  },
  {
    number: "02",
    title: "Decide",
    subtitle: "resolve or escalate",
    description: "Similarity search finds proven solutions, then the decision engine compares confidence against the threshold.",
...
// safety-first by design`,
  },
  {
    ...
    title: "Respond",
    subtitle: "& learn",
    description: "A response is generated or the ticket is assigned to an agent. Feedback updates the quality score per intent.",
    code: `POST /tickets/{id}/feedback
{
  "rating": 5,
  "resolved": true
}
        ...
        <div className="relative mb-0 lg:mb-0 grid lg:grid-cols-2 gap-4 lg:gap-12 items-end">
          ...
          <div className="overflow-hidden pb-0 lg:pb-32">
            ...
            <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.85] transition-all duration-1000 delay-100 ${
              ...
              <span className="block">Classify.</span>
              <span className="block text-white/30">Decide.</span>
              <span className="block text-white/10">Resolve.</span>
            </h2>
          </div>
